...
<?php  include __DIR__."../views/templates/header.php";?>
    ...
    <div class="in_ad_right">
      <form method="post" enctype="multipart/form-data">
        <div class="form-group">
          <label for="advertTitle">عنوان آگهی:</label>
          <input type="text" id="advertTitle" name="advertTitle" required>
        </div>

        <div class="form-group selects">
          <div>
            <label for="advertCategory">گروه آگهی:</label>
            <select id="advertCategory" name="advertCategory" required>
              <option value="category1">لوازم خانگی</option>
              <option value="category2">البسه</option>
          ...
          <div>
            <label for="advertCity">استان:</label>
            <select id="advertCity" name="advertCity" required>
              <option value="city1">City 1</option>
              <option value="city2">City 2</option>
              <option value="city3">City 3</option>
              <!-- Add more options as needed -->
    ...
    <div class="in_ad_left">
      ...
      <input type="submit" name="ad_advert" value="ثبت آگهی">
    </div>
  </div>
