                ...
                if ($advertDetails !== false) {
                        ...
                        <div class="advert_btns">
                            <div>
                                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                                    <input type="hidden" name="delete" value="<?php echo htmlspecialchars($advertDetails['AdvertID'], ENT_QUOTES, 'UTF-8'); ?>">
                                    <button type="submit" style="color:red !important;" onclick="return confirm('Are you sure you want to delete this advert?');">حذف آگهی</button>
                                </form>
                    ...
                    <?php if ($ownerDetails !== false) { ?>
                        <div class="left_detail">
                            ...
                            <div class="edit-delete_buttons">
                                <a href="<?php echo base_url('editprofile.php'); ?>"class="card_green_btn-profile">ویرایش پروفایل</a>
                            </div>
                        </div>
